...
| `telegram-intake.service` | NFL Guesser prediction/intake bot (persistent). |
| `moe-bot.service` | Dedicated MOE group bot (persistent): desk synchronization, channel-native opinion details, and reviewer callbacks. |
