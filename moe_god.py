...
def reason_reference_text(request: dict[str, Any]) -> str:
    ...
    # Records the request states in prose rather than W-L notation. All
    # factor text is generated by this repo's own experts, so these are
    # stable format strings, not free text; a judge re-notating one is
    # citing the request, and 30 live responses were rejected for exactly
    # that on the first full Sunday slate (2026-09-13).
