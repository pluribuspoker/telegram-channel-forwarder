...
- Soccer extra time: When the status shows "AET" (After Extra Time) or "PEN" (penalties), a "(Regulation 90': ...)" note shows the 90-minute score. For moneyline and total bets, use the REGULATION score, NOT the final AET score. Extra-time goals do not count. A regulation draw means moneyline is a PUSH. Exception: if the pick says "to advance" or "to qualify", use the final result.
